...
CF_EXTERN_C_BEGIN
/** \defgroup CFXMLParserRef CFXMLParser Reference (deprecated)
    \{
 */
...
typedef
CFDataRef (*CFXMLParserResolveExternalEntityCallBack)
  (CFXMLParserRef parser, CFXMLExternalID * extID, void *info);
     ...
     typedef CFStringRef (*CFXMLParserCopyDescriptionCallBack) (const void
                                                                *info);
     ...
     CF_EXPORT void
       CFXMLParserGetContext (CFXMLParserRef parser,
                              CFXMLParserContext * context);

     CF_EXPORT void *CFXMLParserGetDocument (CFXMLParserRef parser);

     CF_EXPORT CFIndex CFXMLParserGetLineNumber (CFXMLParserRef parser);

     CF_EXPORT CFIndex CFXMLParserGetLocation (CFXMLParserRef parser);

     CF_EXPORT CFURLRef CFXMLParserGetSourceURL (CFXMLParserRef parser);

     CF_EXPORT CFXMLParserStatusCode
       CFXMLParserGetStatusCode (CFXMLParserRef parser);

     CF_EXPORT Boolean CFXMLParserParse (CFXMLParserRef parser);
/** \} */

/** \defgroup CFXMLTreeRef CFXMLTree Reference (deprecated)
    \{
 */
     ...
     CF_EXPORT CFXMLTreeRef
       CFXMLTreeCreateFromDataWithError (CFAllocatorRef allocator,
                                         CFDataRef xmlData, CFURLRef dataSource,
                                         CFOptionFlags parseOptions,
                                         CFIndex versionOfNodes,
